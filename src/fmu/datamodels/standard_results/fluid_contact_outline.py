...
class FluidContactOutlineSchema(SchemaBase):
    """This class represents the schema that is used to validate the fluid contact
    outline table being exported. This means that the version, schema filename, and
    schemalocation corresponds directly with the values and their validation
    ...
    FluidContactOutlineResultRow model.
